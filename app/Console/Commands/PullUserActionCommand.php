...
class PullUserActionCommand extends BaseCommand
{
     ...
     * @var string
     */
    protected $signature = 'pull_user_order_action {--cp_type=} {--product_type=} {--time=} {--time_interval=} {--product_id=}';
     ...
     * @var string
     */
    protected $description = '拉取用户下单行为数据';
    ...
    public function handle(){
        $actionType = UserActionTypeEnum::ORDER;
