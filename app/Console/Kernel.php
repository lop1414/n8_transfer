...
//        $schedule->command("sync_user_action --action_type=REG --cp_type=FQ --product_type=KYY --time={$oneHourRange}")->cron('*/10 * * * *');
        ...
        $schedule->command("sync_user_action --action_type=REG --cp_type=HS --product_type=DJ_GZH --time={$halfHourRange} --key_suffix=half_hour")->cron('*/30 * * * *');
        $schedule->command("sync_user_action --action_type=REG --cp_type=HS --product_type=DJ_GZH --time={$oneHourRange} --key_suffix=hour")->cron('10 * * * *');
