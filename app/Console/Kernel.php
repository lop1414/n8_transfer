...
use App\Console\Commands\Yw\PullKyyUserActionCommand;
use App\Console\Commands\Yw\PushKyyUserActionCommand;
...
class Kernel extends ConsoleKernel
{
    ...
    protected $commands = [
        ...
        PullKyyUserActionCommand::class,
        PushKyyUserActionCommand::class,
