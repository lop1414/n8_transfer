...
use App\Services\UserAction\CompleteOrder\ZyH5CompleteOrderService;
...
class ZyH5OrderService extends UserActionAbstract
{
    use H5;
    use ZyH5;
    use Order;

    protected $zyH5CompleteOrderService;

    public function __construct()
    {
        $this->zyH5CompleteOrderService = new ZyH5CompleteOrderService();
    }
        ...
        do {
            ...
            do {
                ...
                foreach ($tmp['data'] as $item) {
                    ...
                    // 完成订单
                    if ($item['is_pay'] == 1) {
                        $data[] = $this->zyH5CompleteOrderService->itemFilter($item);
                    }
                }
