...
$router->group([
    ...
    $router->group(['prefix' => 'fq_kyy2'], function () use ($router) {
        $router->post('reg', 'Open\FqKyy\User2Controller@reg');
        $router->post('add_shortcut', 'Open\FqKyy\User2Controller@addShortcut');
    });
